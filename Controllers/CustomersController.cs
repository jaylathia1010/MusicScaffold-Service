...
namespace MusicScaffold.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,IsSubscribedToNewsLetter,Birthdate,MembershipTypeId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,IsSubscribedToNewsLetter,Birthdate,MembershipTypeId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
