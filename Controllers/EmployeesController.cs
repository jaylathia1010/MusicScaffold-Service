...
namespace MusicScaffold.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,EmployeeTypeId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,EmployeeTypeId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
